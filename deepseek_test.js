...
const API_KEY = "sk-2a14b0d916c24de3b45aeddfc05bb6ec";
...
const system_prompt_1 = `你现在是一位专业的内容审核员，你的任务是审核用户发布的内容，判断是否符合平台的规定。
    ...
    5. 内容不能包含任何形式的违法、违规、不良、不良行为。
    6. 内容不能包含任何形式的个人隐私、个人信息、个人身份信息。
    7. 内容不能包含任何形式的广告、推广、销售、交易等。
    8. 内容不能包含任何形式的恶意攻击、恶意破坏、恶意篡改等。`

const system_prompt_2 = `
  你现在是一位语言学和心理学专家，你需要根据用户的发帖内容总结出恰当的标签,如果帖子内容过少，你需要恰当的联想
`

const text = "真烦，还有好多功能没开发😂";
